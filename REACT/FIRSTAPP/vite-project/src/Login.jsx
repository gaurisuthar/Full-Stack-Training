  ...
  return (
   <div className='w-4/5 h-4/5 bg-white flex rounded shadow-xl'>
    ...
    <div className='w-1/2 flex flex-col justify-center items-center gap-5'>
        ...
        <button type='submit' className='p-2 w-3/5 bg-gray-700 rounded text-white font-medium active:bg-gray-800 shadow'>{loading? <CircularProgress color='grey' size={20} />:"Login"}</button>
        </form>
    </div>
   </div>
  )
